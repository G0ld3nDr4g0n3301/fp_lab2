...
2. Сделать mapBag инстансом Functor не выйдет, так как в сигнатуре Functor От элементов не требуется сравнимость, а мне нужен Ord для сравнения элементов.
